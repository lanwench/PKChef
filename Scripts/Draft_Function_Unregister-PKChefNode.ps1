...
.EXAMPLE
Remove-PKChefNode -ChefNodeName ops-bastion-1.internal.domain.com
Deleted node[ops-bastion-1.internal.domain.com]
Deleted client[ops-bastion-1.internal.domain.com]

.EXAMPLE
Remove-PKChefNode OPS-PKTEST-501.internal.domain.com -Backup
Backup successfully created.
Deleted node[OPS-PKTEST-501.internal.domain.com]
Deleted client[OPS-PKTEST-501.internal.domain.com]


.EXAMPLE
Remove-PKChefNode ops-bastion-601.internal.domain.com -Backup -BackupFilePath 20160504_ops-bastion-601.json -Verbose
Loading node configuration for 'ops-bastion-601.internal.domain.com'...
Saving JSON export to backup file: '20160504_ops-bastion-601.json'...
Backup successfully created.
Deleted node[ops-bastion-601.internal.domain.com]
Deleted client[ops-bastion-601.internal.domain.com]

.NOTES
File:       Function_Get-ActiveDirectoryFqdn.ps1
Version:    1.1
Author:     Mario Fischer (mfischer@domain.com)
